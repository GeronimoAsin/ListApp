...
@Composable
fun AddProductForm(onDismiss: () -> Unit, onConfirm: (String, String) -> Unit) {
    ...
    Dialog(onDismissRequest = onDismiss) {
        Card(
            ...
            Column(
                ...
                Text(stringResource(id = R.string.add_product), style = MaterialTheme.typography.headlineSmall, fontWeight = FontWeight.Bold)
